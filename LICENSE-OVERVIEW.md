...
**Repository:** `quantova-chain-specs` — Quantova Chain Specs
...
This repository provides the genesis files, chain specs, bootnodes, public RPC endpoints, and full specification for the Quantova network, and forms part of this stack.
...
- **Licensed Work:** `quantova-chain-specs` — Quantova Chain Specs, © 2026 Quantova Inc.
...
This repository provides the canonical chain specifications and network artifacts for Quantova: genesis files, raw chain specs, bootnodes, public RPC endpoints, the full chain specification, and read-only metrics scripts that use the qweb3.js and qweb3.py client libraries. It contains specification documents and machine-readable chain-spec files. It does not contain private keys, secrets, validator key material, or any code that performs on-chain actions.
